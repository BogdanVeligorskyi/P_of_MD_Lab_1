...
// class for play window activity
public class PlayActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // initializing all fields for 1st question
        ...
        // if activity started to work from button in main menu
        } else {
    ...
    private void setupQuestionPrice() {
        ...
        String text_price = "$" + String.valueOf(question_price);
    ...
    private void setupQuestionsNum() {
        ...
        String text_question_num = "Question " + String.valueOf(current_question_num) + " of " + options.getNumber_of_questions();
    ...
    private void removeIncorrectAnswers(CheckBox cb) {
